...
class ProductEffectIntentEntity {
    ...
    @Column(name = "tool_call_owner_kind", nullable = false, length = 32)
    private String toolCallOwnerKind;
    ...
    String toolCallOwnerKind() { return toolCallOwnerKind; }
