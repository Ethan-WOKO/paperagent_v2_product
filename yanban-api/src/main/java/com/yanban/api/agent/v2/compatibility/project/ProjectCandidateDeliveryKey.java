...
@Embeddable
class ProjectCandidateDeliveryKey implements Serializable {
    ...
    protected ProjectCandidateDeliveryKey() {}

    ProjectCandidateDeliveryKey(Long userId, Long projectId, Long sessionId,
    ...
    @Override public boolean equals(Object other) {
        return other instanceof ProjectCandidateDeliveryKey key
