...
CREATE INDEX idx_demo_chat_archive_user_updated
    ON demo_chat_archive_sessions(user_id, session_updated_at);
...
CREATE INDEX idx_demo_chat_archive_message_order
    ON demo_chat_archive_messages(archive_session_id, message_created_at, id);
