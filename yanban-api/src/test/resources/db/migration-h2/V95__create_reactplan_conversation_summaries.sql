...
CREATE INDEX idx_reactplan_summary_work
    ON reactplan_conversation_summaries(state, lease_expires_at, updated_at);

CREATE INDEX idx_reactplan_summary_user
    ON reactplan_conversation_summaries(user_id, updated_at);
