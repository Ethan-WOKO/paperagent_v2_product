...
CREATE INDEX idx_memory_distillation_settings_due
    ON agent_memory_distillation_settings (auto_enabled, next_run_at);
...
CREATE INDEX idx_memory_distillation_jobs_user_created
    ON agent_memory_distillation_jobs (user_id, created_at, id);

CREATE INDEX idx_memory_distillation_jobs_claim
    ON agent_memory_distillation_jobs (status, claimed_until, id);
