...
public record StepPauseRequest(
        PlanId planId,
        String leaseToken,
        long fencingToken,
        ...
        PlanStepId stepId,
        EventEnvelope pauseEvent,
        Checkpoint pausedCheckpoint) {

    public StepPauseRequest {
        ...
        Objects.requireNonNull(pausedCheckpoint, "pausedCheckpoint");
    }

    @Override
    public String toString() {
        return "StepPauseRequest["
                + "planId=<provided>, "
                + "leaseToken=<provided>, "
