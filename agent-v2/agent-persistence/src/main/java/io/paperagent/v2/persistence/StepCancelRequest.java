...
public record StepCancelRequest(
        PlanId planId,
        String leaseToken,
        long fencingToken,
        ...
        PlanStepId stepId,
        EventEnvelope cancellationEvent,
        Checkpoint cancelledCheckpoint) {

    public StepCancelRequest {
        ...
        Objects.requireNonNull(cancellationEvent, "cancellationEvent");
        Objects.requireNonNull(cancelledCheckpoint, "cancelledCheckpoint");
    }

    @Override
    public String toString() {
        return "StepCancelRequest["
                + "planId=<provided>, "
                + "leaseToken=<provided>, "
                ...
                + "stepId=<provided>, "
                + "cancellationEvent=<provided>, "
                + "cancelledCheckpoint=<provided>]";
    }
