...
> 文档分类：**已被替代**。本文描述旧 Runtime 生命周期；当前 V2 Plan、lease、checkpoint、Step Result 和 Receipt 合同以 V2 集成文档为准。

> **状态：HISTORICAL / PARTIALLY SUPERSEDED（2026-07-27）。**
> 当前 Agent 核心边界以 `docs/当前有效/架构设计/v2-agent-core-integration.md` 和
