> 2026-09-19：当前 Project 为 TypeScript ReAct，详见 [当前架构](../架构设计/project-react-runtime.md)。下方 V2 专项仅适用于历史兼容/复用基础设施，不是现行项目编排路线；#228 必须验证旧入口停用、GET 不恢复、后台不启动旧修复，并保留 ReAct、工作区和文献回归。
